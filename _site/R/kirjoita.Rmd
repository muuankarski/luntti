        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
              ...
              <ul class="dropdown-menu" aria-labelledby="R">
                <li><a href="/R/lue.html">Lukeminen</a></li>
                <li><a href="/R/kirjoita.html">Kirjoittaminen</a></li>
              </ul>         
         </ul>
         <ul class="nav navbar-nav">
                <li class="dropdown">
         ...
         <ul class="nav navbar-nav">
              ...
              <ul class="dropdown-menu" aria-labelledby="versio">
                <li><a href="/toistettava/lue.html">Lukeminen</a></li>
                <li><a href="/toistettava/kirjoita.html">Kirjoittaminen</a></li>
              </ul>         
         </ul>
         <ul class="nav navbar-nav">
              ...
              <ul class="dropdown-menu" aria-labelledby="versio">
                <li><a href="/julkaiseminen/lue.html">latex</a></li>
                <li><a href="/julkaiseminen/kirjoita.html">jekyll</a></li>
              </ul>         
         </ul>
...
<!--
         ...
         <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="mailto:vaphana@gmail.com?Subject=Terve Vaphana!" title="Email!" target="_top"><i class="fa fa-envelope fa-2x"></i></a></li>                        
        		<li><a href="https://twitter.com/vaphana" title="Twitter"><i class="fa fa-twitter fa-2x"></i></a></li>
                        <li><a href="https://github.com/vaphana" title="Github"><i class="fa fa-github fa-2x"></i></a></li>
		        <li><a href="/index_en.html" title="In English"><i class="fa fa-language fa-2x"></i></a></li>
-->
